...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : t(
          ((e =
            "undefined" != typeof globalThis ? globalThis : e || self).mdui =
            {})
        );
})(this, function (e) {
  "use strict";
  ...
  ((e.Icon = class extends Jt {
    constructor() {
      (super(...arguments),
        (this.hasSlotController = new Zt(this, "[default]")));
    }
    render() {
      return this.hasSlotController.test("[default]")
        ...
        : (() => {
            if (this.name) {
              ...
              return ft`<span translate="no" style="${Xt({ fontFamily: i.get(t) })}">${e}</span>`;
            }
  ...
  ((e.Avatar = class extends Jt {
    ...
    render() {
      return this.hasSlotController.test("[default]")
        ? ft`<slot></slot>`
        : this.src
          ? ft`<img part="image" alt="${Vt(this.label)}" src="${this.src}" style="${Xt({ objectFit: this.fit })}">`
          : this.icon
  ...
  const Ki = (e) => {
    class t extends e {
      renderAnchor({
        ...
        return ft`<a ${n} id="${Vt(e)}" class="_a ${t || ""}" part="${Vt(i)}" href="${Vt(this.href)}" download="${Vt(this.download)}" target="${Vt(this.target)}" rel="${Vt(this.rel)}" tabindex="${Vt(r)}">${o}</a>`;
      }
    }
    return (
  ...
  ((e.CircularProgress = class extends Jt {
    ...
    render() {
      ...
      return ft`<div class="progress ${Gi({ determinate: e, indeterminate: !e })}">${e ? this.renderDeterminate() : this.renderInDeterminate()}</div>`;
    }
    renderDeterminate() {
      const e = this.value,
        t = 3.1415926,
      ...
      return ft`<svg viewBox="0 0 ${40} ${40}"><circle class="track" cx="${i}" cy="${i}" r="${18}" stroke-width="${4}"></circle><circle class="circle" cx="${i}" cy="${i}" r="${18}" stroke-dasharray="${2 * t * 18}" stroke-dashoffset="${n}" stroke-width="${4}"></circle></svg>`;
    }
    renderInDeterminate() {
      const e = 113.0973336,
        t = (t) =>
  ...
  ((e.Ripple = class extends Jt {
    ...
    render() {
      return ft`<div ${Ni(this.surfaceRef)} class="surface ${Gi({ hover: this.hover, focused: this.focused, dragged: this.dragged })}"></div>`;
    }
  }),
  ...
  class Qi extends Ki(Ji(Wi(Jt))) {
    ...
    renderButton({
      ...
      return ft`<button id="${Vt(e)}" class="${Fi(["_button", t])}" part="${Vt(i)}" ?disabled="${this.rippleDisabled || this.focusDisabled}">${o}</button>`;
    }
    isButton() {
      return !this.href;
    }
  ...
  ((e.Button = class extends Qi {
    ...
    render() {
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.isButton() ? this.renderButton({ className: "button", part: "button", content: this.renderInner() }) : this.disabled || this.loading ? ft`<span part="button" class="button _a">${this.renderInner()}</span>` : this.renderAnchor({ className: "button", part: "button", content: this.renderInner() })}`;
    }
    renderIcon() {
      return this.loading
        ? this.renderLoading()
        : ft`<slot name="icon" part="icon" class="icon">${this.icon ? ft`<mdui-icon name="${this.icon}"></mdui-icon>` : Qt}</slot>`;
    }
    renderLabel() {
      return ft`<slot part="label" class="label"></slot>`;
    }
    renderEndIcon() {
      return ft`<slot name="end-icon" part="end-icon" class="end-icon">${this.endIcon ? ft`<mdui-icon name="${this.endIcon}"></mdui-icon>` : Qt}</slot>`;
    }
    renderInner() {
  ...
  ((e.Card = class extends Ki(Ji(Wi(Jt))) {
    ...
    render() {
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.href && !this.disabled ? this.renderAnchor({ className: "link", content: ft`<slot></slot>` }) : ft`<slot></slot>`}`;
    }
  }),
    (e.Card.styles = [ei, io]),
  ...
  const ro = Pe`:host{display:inline-block;width:1em;height:1em;line-height:1;font-size:1.5rem}`,
    so = (e) =>
      ft`<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="currentColor">${oi(e)}</svg>`;
  ...
  ((e.Chip = class extends Qi {
    ...
    render() {
      ...
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.isButton() ? this.renderButton({ className: o, part: "button", content: this.renderInner() }) : this.disabled || this.loading ? ft`<span part="button" class="${o} _a">${this.renderInner()}</span>` : this.renderAnchor({ className: o, part: "button", content: this.renderInner() })}`;
    }
    onClick() {
      this.disabled ||
        this.loading ||
    ...
    renderIcon() {
      ...
      const e = () =>
        this.icon
          ...
          : Qt;
      return this.selected
        ? ft`<slot name="selected-icon" part="selected-icon" class="selected-icon">${(() => (this.selectedIcon ? ft`<mdui-icon name="${this.selectedIcon}" class="i"></mdui-icon>` : "assist" === this.variant || "filter" === this.variant ? ft`<mdui-icon-check class="i"></mdui-icon-check>` : e()))()}</slot>`
    ...
    renderEndIcon() {
      return ft`<slot name="end-icon" part="end-icon" class="end-icon">${this.endIcon ? ft`<mdui-icon name="${this.endIcon}" class="i"></mdui-icon>` : Qt}</slot>`;
    }
    renderDeleteIcon() {
      return this.deletable
        ? ft`<slot name="delete-icon" part="delete-icon" class="delete-icon" @click="${this.onDelete}">${this.deleteIcon ? ft`<mdui-icon name="${this.deleteIcon}" class="i"></mdui-icon>` : ft`<mdui-icon-clear class="i"></mdui-icon-clear>`}</slot>`
        : Qt;
    }
    renderInner() {
      return [
  ...
  ((e.CollapseItem = class extends Jt {
    ...
    render() {
      return ft`<slot name="header" part="header" class="header">${this.header}</slot><slot part="body" class="body ${Gi({ opened: "opened" === this.state, active: this.active })}" ${Ni(this.bodyRef)} @transitionend="${this.onTransitionEnd}"></slot>`;
    }
    onTransitionEnd(e) {
  ...
  ((e.Dialog = class extends Jt {
    ...
    render() {
      const e = this.hasSlotController.test("action"),
        ...
        s = n || t;
      return ft`<div ${Ni(this.overlayRef)} part="overlay" class="overlay" @click="${this.onOverlayClick}" tabindex="-1"></div><div ${Ni(this.panelRef)} part="panel" class="panel ${Gi({ "has-icon": i, "has-description": n, "has-default": t })}" tabindex="0">${bo(r, () => ft`<slot name="header" part="header" class="header">${bo(i, () => this.renderIcon())} ${bo(o, () => this.renderHeadline())}</slot>`)} ${bo(s, () => ft`<div ${Ni(this.bodyRef)} part="body" class="body">${bo(n, () => this.renderDescription())}<slot></slot></div>`)} ${bo(e, () => ft`<slot name="action" part="action" class="action"></slot>`)}</div>`;
    }
    onOverlayClick() {
    ...
    renderIcon() {
      return ft`<slot name="icon" part="icon" class="icon">${this.icon ? ft`<mdui-icon name="${this.icon}"></mdui-icon>` : Qt}</slot>`;
    }
    renderHeadline() {
  ...
  ((e.Dropdown = class extends Jt {
    ...
    render() {
      return ft`<slot name="trigger" part="trigger" class="trigger"></slot><slot ${Ni(this.panelRef)} part="panel" class="panel" hidden @click="${this.onPanelClick}"></slot>`;
    }
    getCssScaleName() {
  ...
  ((e.Fab = class extends Qi {
    ...
    render() {
      ...
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.isButton() ? this.renderButton({ className: e, part: "button", content: this.renderInner() }) : this.disabled || this.loading ? ft`<span part="button" class="_a ${e}">${this.renderInner()}</span>` : this.renderAnchor({ className: e, part: "button", content: this.renderInner() })}`;
    }
    renderLabel() {
      return ft`<slot part="label" class="label"></slot>`;
    }
  ...
  ((e.LinearProgress = class extends Jt {
    ...
    render() {
      if (!u(this.value)) {
        const e = this.value;
        return ft`<div part="indicator" class="determinate" style="${Xt({ width: (e / Math.max(this.max ?? e, e)) * 100 + "%" })}"></div>`;
      }
  ...
  ((e.ListItem = class extends Ki(Ji(Wi(Jt))) {
    ...
    render() {
      ...
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.href && !this.disabled ? this.renderAnchor({ className: t, content: this.renderInner(), part: "container", refDirective: Ni(this.itemRef) }) : ft`<div part="container" class="${t}" ${Ni(this.itemRef)}>${this.renderInner()}</div>`}`;
    }
    renderInner() {
      const e = this.hasSlotController.test("[default]");
      return ft`<slot name="custom"><slot name="icon" part="icon" class="icon">${this.icon ? ft`<mdui-icon name="${this.icon}"></mdui-icon>` : Qt}</slot><div part="body" class="body">${e ? ft`<slot part="headline" class="headline"></slot>` : ft`<div part="headline" class="headline">${this.headline}</div>`}<slot name="description" part="description" class="description">${this.description}</slot></div><slot name="end-icon" part="end-icon" class="end-icon">${this.endIcon ? ft`<mdui-icon name="${this.endIcon}"></mdui-icon>` : Qt}</slot></slot>`;
    }
  }),
  ...
  ((e.MenuItem = class extends Ki(Ji(Wi(Jt))) {
    ...
    render() {
      ...
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.href && !this.disabled ? this.renderAnchor({ part: "container", className: a, content: this.renderInner(o, r), refDirective: Ni(this.containerRef), tabIndex: this.focusable ? 0 : -1 }) : ft`<div part="container" ${Ni(this.containerRef)} class="${a}">${this.renderInner(o, r)}</div>`} ${bo(e, () => ft`<slot name="submenu" ${Ni(this.submenuRef)} part="submenu" class="submenu" hidden></slot>`)}`;
    }
    onOuterClick(e) {
      this.disabled ||
        !this.submenuOpen ||
    ...
    renderInner(e, t) {
      return ft`<slot name="custom">${this.selected ? ft`<slot name="selected-icon" part="selected-icon" class="selected-icon">${this.selectedIcon ? ft`<mdui-icon name="${this.selectedIcon}" class="i"></mdui-icon>` : ft`<mdui-icon-check class="i"></mdui-icon-check>`}</slot>` : ft`<slot name="icon" part="icon" class="icon">${t ? ft`<mdui-icon name="${this.icon}" class="i"></mdui-icon>` : Qt}</slot>`}<div class="label-container"><slot part="label" class="label"></slot></div><slot name="end-text" part="end-text" class="end-text">${this.endText}</slot>${e ? ft`<mdui-icon-arrow-right part="end-icon" class="end-icon arrow-right"></mdui-icon-arrow-right>` : ft`<slot name="end-icon" part="end-icon" class="end-icon">${this.endIcon ? ft`<mdui-icon name="${this.endIcon}"></mdui-icon>` : Qt}</slot>`}</slot>`;
    }
  }),
  ...
  ((e.NavigationBarItem = class extends Ki(Ji(Wi(Jt))) {
    ...
    render() {
      ...
      return ft`<mdui-ripple .noRipple="${!this.active || this.noRipple}" class="${e}" ${Ni(this.rippleRef)}></mdui-ripple>${this.href ? this.renderAnchor({ part: "container", className: t, content: this.renderInner() }) : ft`<div part="container" class="${t}">${this.renderInner()}</div>`}`;
    }
    renderInner() {
      return ft`<div part="indicator" class="indicator"><slot name="badge" part="badge" class="badge"></slot><slot name="active-icon" part="active-icon" class="active-icon">${this.activeIcon ? ft`<mdui-icon name="${this.activeIcon}"></mdui-icon>` : Qt}</slot><slot name="icon" part="icon" class="icon">${this.icon ? ft`<mdui-icon name="${this.icon}"></mdui-icon>` : Qt}</slot></div><slot part="label" class="label"></slot>`;
    }
  }),
  ...
  ((e.NavigationDrawer = class extends Li {
    ...
    render() {
      return ft`${bo(this.isModal, () => ft`<div ${Ni(this.overlayRef)} part="overlay" class="overlay" @click="${this.onOverlayClick}"></div>`)}<slot ${Ni(this.panelRef)} part="panel" class="panel" tabindex="0"></slot>`;
    }
    setObserveResize() {
  ...
  ((e.NavigationRail = class extends Li {
    ...
    render() {
      ...
      return ft`${bo(e, () => ft`<slot name="top" part="top" class="top"></slot>`)} <span class="top-spacer"></span><slot part="items" class="items" @slotchange="${this.onSlotChange}" @click="${this.onClick}"></slot><span class="bottom-spacer"></span> ${bo(t, () => ft`<slot name="bottom" part="bottom" class="bottom"></slot>`)}`;
    }
    onClick(e) {
      if (e.button) return;
  ...
  ((e.NavigationRailItem = class extends Ki(Ji(Wi(Jt))) {
    ...
    render() {
      ...
      return ft`${this.href ? this.renderAnchor({ part: "container", className: t, content: this.renderInner(e) }) : ft`<div part="container" class="${t}">${this.renderInner(e)}</div>`}<mdui-ripple .noRipple="${!this.active || this.noRipple}" ${Ni(this.rippleRef)}></mdui-ripple>`;
    }
    renderInner(e) {
      return ft`<div part="indicator" class="indicator"><slot name="badge" part="badge" class="${Gi({ badge: !0, "placement-right": "right" === this.placement })}"></slot><slot name="active-icon" part="active-icon" class="active-icon">${this.activeIcon ? ft`<mdui-icon name="${this.activeIcon}"></mdui-icon>` : Qt}</slot><slot name="icon" part="icon" class="icon">${this.icon ? ft`<mdui-icon name="${this.icon}"></mdui-icon>` : Qt}</slot></div>${e ? ft`<slot part="label" class="label"></slot>` : gt}`;
    }
  }),
  ...
  ((e.RadioGroup = class extends Jt {
    ...
    render() {
      return ft`<fieldset><input ${Ni(this.inputRef)} type="radio" class="input" name="${Vt(this.name)}" value="${Vt(this.value)}" .checked="${!!this.value}" .required="${this.required}" tabindex="-1" @keydown="${this.onKeyDown}"><slot @click="${this.onClick}" @keydown="${this.onKeyDown}" @slotchange="${this.onSlotChange}" @change="${this.onCheckedChange}"></slot></fieldset>`;
    }
  ...
  class Yn extends Ji(Wi(Jt)) {
    ...
    renderLabel(e) {
      return bo(
        !this.nolabel,
        () =>
          ft`<div part="label" class="label ${Gi({ "label-visible": this.labelVisible })}">${this.labelFormatter(e)}</div>`
      );
    }
    onChange() {
      this.emit("change");
  ...
  ((Yn.styles = [ei, Gn]),
    ...
    (e.RangeSlider = class extends Yn {
      ...
      render() {
        return ft`<label class="${Gi({ invalid: this.invalid })}"><input ${Ni(this.inputRef)} type="range" step="${this.step}" min="${this.min}" max="${this.max}" ?disabled="${this.disabled}" @input="${this.onInput}" @change="${this.onChange}"><div part="track-inactive" class="track-inactive"></div><div ${Ni(this.trackActiveRef)} part="track-active" class="track-active"></div><div ${Ni(this.handleStartRef)} part="handle" class="handle start" style="${Xt({ "z-index": "start" === this.currentHandle ? "2" : "1" })}"><div class="elevation"></div><mdui-ripple ${Ni(this.rippleStartRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.renderLabel(this.value[0])}</div><div ${Ni(this.handleEndRef)} part="handle" class="handle end" style="${Xt({ "z-index": "end" === this.currentHandle ? "2" : "1" })}"><div class="elevation"></div><mdui-ripple ${Ni(this.rippleEndRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.renderLabel(this.value[1])}</div>${bo(this.tickmarks, () => Wn(this.getCandidateValues(), (e) => ft`<div part="tickmark" class="tickmark ${Gi({ active: e > this.value[0] && e < this.value[1] })}" style="${Xt({ left: ((e - this.min) / this.max) * 100 + "%", display: e === this.value[0] || e === this.value[1] ? "none" : "block" })}"></div>`))}</label>`;
      }
      updateStyle() {
  ...
  ((e.SegmentedButton = class extends Qi {
    ...
    render() {
      ...
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.isButton() ? this.renderButton({ className: e, part: "button", content: this.renderInner() }) : this.isDisabled() || this.loading ? ft`<span part="button" class="_a ${e}">${this.renderInner()}</span>` : this.renderAnchor({ className: e, part: "button", content: this.renderInner() })}`;
    }
    isDisabled() {
      return this.disabled || this.groupDisabled;
    }
    renderIcon() {
      return this.loading
        ? this.renderLoading()
        : this.selected
          ? ft`<slot name="selected-icon" part="selected-icon" class="selected-icon">${this.selectedIcon ? ft`<mdui-icon name="${this.selectedIcon}" class="i"></mdui-icon>` : ft`<mdui-icon-check class="i"></mdui-icon-check>`}</slot>`
          : ft`<slot name="icon" part="icon" class="icon">${this.icon ? ft`<mdui-icon name="${this.icon}" class="i"></mdui-icon>` : Qt}</slot>`;
    }
    renderLabel() {
      return this.hasSlotController.test("[default]")
  ...
  ((e.SegmentedButtonGroup = class extends Jt {
    ...
    render() {
      return ft`${bo(this.isSelectable && this.isSingle, () => ft`<input ${Ni(this.inputRef)} type="radio" name="${Vt(this.name)}" value="1" .disabled="${this.disabled}" .required="${this.required}" .checked="${!!this.value}" tabindex="-1" @keydown="${this.onInputKeyDown}">`)}${bo(this.isSelectable && this.isMultiple, () => ft`<select ${Ni(this.inputRef)} name="${Vt(this.name)}" .disabled="${this.disabled}" .required="${this.required}" multiple="multiple" tabindex="-1" @keydown="${this.onInputKeyDown}">${Wn(this.value, (e) => ft`<option selected="selected" value="${e}"></option>`)}</select>`)}<slot @slotchange="${this.onSlotChange}" @click="${this.onClick}"></slot>`;
    }
    selectOne(e) {
      if (this.isMultiple) {
        const t = [...this.selectedKeys];
  ...
  ((e.TextField = class extends Wi(Jt) {
    ...
    render() {
      ...
      return ft`<div part="container" class="${u}">${this.renderPrefix()}<div class="input-container">${this.renderLabel()} ${this.isTextarea ? this.renderTextArea(d) : this.renderInput(d)} ${bo(d, () => ft`<slot name="input" class="input"></slot>`)}</div>${this.renderSuffix()}${this.renderClearButton(n)} ${this.renderTogglePasswordButton(o)} ${this.renderRightIcon(i)}</div>${bo(l || a || c, () => ft`<div part="supporting" class="${Gi({ supporting: !0, ...h })}">${this.renderHelper(l, a)} ${this.renderCounter(c)}</div>`)}`;
    }
    ...
    renderPrefix() {
      return ft`<slot name="icon" part="icon" class="icon">${this.icon ? ft`<mdui-icon name="${this.icon}" class="i"></mdui-icon>` : Qt}</slot><slot name="prefix" part="prefix" class="prefix">${this.prefix}</slot>`;
    }
    renderSuffix() {
    ...
    renderRightIcon(e) {
      return e
        ? ft`<slot name="error-icon" part="error-icon" class="right-icon">${this.errorIcon ? ft`<mdui-icon name="${this.errorIcon}" class="i"></mdui-icon>` : ft`<mdui-icon-error class="i"></mdui-icon-error>`}</slot>`
        : ft`<slot name="end-icon" part="end-icon" class="end-icon right-icon">${this.endIcon ? ft`<mdui-icon name="${this.endIcon}" class="i"></mdui-icon>` : Qt}</slot>`;
    }
    renderClearButton(e) {
      return bo(
        e,
        () =>
          ft`<slot name="clear-button" part="clear-button" class="action" @click="${this.onClear}"><mdui-button-icon tabindex="-1"><slot name="clear-icon" part="clear-icon">${this.clearIcon ? ft`<mdui-icon name="${this.clearIcon}" class="i"></mdui-icon>` : ft`<mdui-icon-cancel--outlined class="i"></mdui-icon-cancel--outlined>`}</slot></mdui-button-icon></slot>`
      );
    }
    renderTogglePasswordButton(e) {
      return bo(
        e,
        () =>
          ft`<slot name="toggle-password-button" part="toggle-password-button" class="action" @click="${this.onTogglePassword}"><mdui-button-icon tabindex="-1">${this.isPasswordVisible ? ft`<slot name="show-password-icon" part="show-password-icon">${this.showPasswordIcon ? ft`<mdui-icon name="${this.showPasswordIcon}" class="i"></mdui-icon>` : ft`<mdui-icon-visibility-off class="i"></mdui-icon-visibility-off>`}</slot>` : ft`<slot name="hide-password-icon" part="hide-password-icon">${this.hidePasswordIcon ? ft`<mdui-icon name="${this.hidePasswordIcon}" class="i"></mdui-icon>` : ft`<mdui-icon-visibility class="i"></mdui-icon-visibility>`}</slot>`}</mdui-button-icon></slot>`
      );
    }
    renderInput(e) {
      return ft`<input ${Ni(this.inputRef)} part="input" class="input ${Gi({ "hide-input": e })}" type="${"password" === this.type && this.isPasswordVisible ? "text" : this.type}" name="${Vt(this.name)}" .value="${oo(this.value)}" placeholder="${Vt(!this.label || this.isFocusedStyle || this.hasValue ? this.placeholder : void 0)}" ?readonly="${this.readonly}" ?disabled="${this.disabled}" ?required="${this.required}" minlength="${Vt(this.minlength)}" maxlength="${Vt(this.maxlength)}" min="${Vt(this.min)}" max="${Vt(this.max)}" step="${Vt(this.step)}" autocapitalize="${Vt("password" === this.type ? "off" : this.autocapitalize)}" autocomplete="${this.autocomplete}" autocorrect="${Vt("password" === this.type ? "off" : this.autocorrect)}" spellcheck="${Vt(this.spellcheck)}" pattern="${Vt(this.pattern)}" enterkeyhint="${Vt(this.enterkeyhint)}" inputmode="${Vt(this.inputmode)}" @change="${this.onChange}" @input="${this.onInput}" @invalid="${this.onInvalid}" @keydown="${this.onKeyDown}">`;
    }
    renderTextArea(e) {
      return ft`<textarea ${Ni(this.inputRef)} part="input" class="input ${Gi({ "hide-input": e })}" name="${Vt(this.name)}" .value="${oo(this.value)}" placeholder="${Vt(!this.label || this.isFocusedStyle || this.hasValue ? this.placeholder : void 0)}" ?readonly="${this.readonly}" ?disabled="${this.disabled}" ?required="${this.required}" minlength="${Vt(this.minlength)}" maxlength="${Vt(this.maxlength)}" rows="${this.rows ?? 1}" autocapitalize="${Vt(this.autocapitalize)}" autocorrect="${Vt(this.autocorrect)}" spellcheck="${Vt(this.spellcheck)}" enterkeyhint="${Vt(this.enterkeyhint)}" inputmode="${Vt(this.inputmode)}" @change="${this.onChange}" @input="${this.onInput}" @invalid="${this.onInvalid}" @keydown="${this.onKeyDown}" @keyup="${this.onTextAreaKeyUp}"></textarea>`;
    }
    renderHelper(e, t) {
      return e
        ? ft`<div part="error" class="error">${this.error || this.inputRef.value.validationMessage}</div>`
        : t
  ...
  ((e.Select = class extends Wi(Jt) {
    ...
    render() {
      ...
      return ft`${this.multiple ? ft`<select ${Ni(this.hiddenInputRef)} class="hidden-input" name="${Vt(this.name)}" value="${Vt(this.value)}" .required="${this.required}" .disabled="${this.disabled}" multiple="multiple" tabindex="-1">${Wn(this.value, (e) => ft`<option selected="selected" value="${e}"></option>`)}</select>` : ft`<input ${Ni(this.hiddenInputRef)} type="radio" class="hidden-input" name="${Vt(this.name)}" value="${Vt(this.value)}" .required="${this.required}" .disabled="${this.disabled}" .checked="${e}" tabindex="-1">`}<mdui-dropdown .stayOpenOnClick="${this.multiple}" .disabled="${this.readonly || this.disabled}" .placement="${"top" === this.placement ? "top-start" : "bottom" === this.placement ? "bottom-start" : "auto"}" @open="${this.onDropdownOpen}" @close="${this.onDropdownClose}"><mdui-text-field ${Ni(this.textFieldRef)} slot="trigger" part="text-field" class="text-field" exportparts="${["container", "icon", "end-icon", "error-icon", "prefix", "suffix", "label", "input", "clear-button", "clear-icon", "supporting", "helper", "error"].map((e) => `${e}:text-field__${e}`).join(",")}" readonly="readonly" .readonlyButClearable="${!0}" .variant="${this.variant}" .name="${this.name}" .value="${this.multiple ? (this.value.length ? " " : "") : this.getMenuItemLabelByValue(this.value)}" .label="${this.label}" .placeholder="${this.placeholder}" .helper="${this.helper}" .error="${this.hiddenInputRef.value?.validationMessage}" .clearable="${this.clearable}" .clearIcon="${this.clearIcon}" .endAligned="${this.endAligned}" .prefix="${this.prefix}" .suffix="${this.suffix}" .icon="${this.icon}" .endIcon="${this.endIcon}" .errorIcon="${this.errorIcon}" .form="${this.form}" .disabled="${this.disabled}" .required="${this.required}" .invalidStyle="${this.invalid}" @clear="${this.onClear}" @change="${(e) => e.stopPropagation()}" @keydown="${this.onTextFieldKeyDown}">${Wn(["icon", "end-icon", "error-icon", "prefix", "suffix", "clear-button", "clear-icon", "helper"], (e) => (this.hasSlotController.test(e) ? ft`<slot name="${e}" slot="${e}"></slot>` : gt))} ${bo(this.multiple && this.value.length, () => ft`<div slot="input" class="chips" part="chips">${Wn(this.value, (e) => ft`<mdui-chip class="chip" part="chip" exportparts="${["button", "label", "delete-icon"].map((e) => `${e}:chip__${e}`).join(",")}" variant="input" deletable tabindex="-1" @delete="${() => this.onDeleteOneValue(e)}">${this.getMenuItemLabelByValue(e)}</mdui-chip>`)}</div>`)}</mdui-text-field><mdui-menu ${Ni(this.menuRef)} part="menu" .selects="${this.multiple ? "multiple" : "single"}" .value="${this.value}" @change="${this.onValueChange}"><slot></slot></mdui-menu></mdui-dropdown>`;
    }
  ...
  ((e.Slider = class extends Yn {
    ...
    render() {
      return ft`<label class="${Gi({ invalid: this.invalid })}"><input ${Ni(this.inputRef)} type="range" step="${this.step}" min="${this.min}" max="${this.max}" ?disabled="${this.disabled}" .value="${oo(this.value.toString())}" @input="${this.onInput}" @change="${this.onChange}"><div part="track-inactive" class="track-inactive"></div><div ${Ni(this.trackActiveRef)} part="track-active" class="track-active"></div><div ${Ni(this.handleRef)} part="handle" class="handle"><div class="elevation"></div><mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${this.renderLabel(this.value)}</div>${bo(this.tickmarks, () => Wn(this.getCandidateValues(), (e) => ft`<div part="tickmark" class="tickmark ${Gi({ active: e < this.value })}" style="${Xt({ left: ((e - this.min) / this.max) * 100 + "%", display: e === this.value ? "none" : "block" })}"></div>`))}</label>`;
    }
    updateStyle() {
          ...
          : [
              ...
              if (e.placement === i) {
                const o = sr.filter(
                  ...
                  n = o.reduce((e, t) => e + t.height, 0);
                ((e.style[i.startsWith("top") ? "top" : "bottom"] =
  ...
  ((e.Switch = class extends Ji(Wi(Jt)) {
    ...
    render() {
      return ft`<label class="${Gi({ invalid: this.invalid, "has-unchecked-icon": this.uncheckedIcon || this.hasSlotController.test("unchecked-icon") })}"><input ${Ni(this.inputRef)} type="checkbox" name="${Vt(this.name)}" value="${Vt(this.value)}" .disabled="${this.disabled}" .checked="${oo(this.checked)}" .required="${this.required}" @change="${this.onChange}"><div part="track" class="track"><div part="thumb" class="thumb"><mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple><slot name="checked-icon" part="checked-icon" class="checked-icon">${this.checkedIcon ? ft`<mdui-icon name="${this.checkedIcon}" class="i"></mdui-icon>` : "" === this.checkedIcon ? Qt : ft`<mdui-icon-check class="i"></mdui-icon-check>`}</slot><slot name="unchecked-icon" part="unchecked-icon" class="unchecked-icon">${this.uncheckedIcon ? ft`<mdui-icon name="${this.uncheckedIcon}" class="i"></mdui-icon>` : Qt}</slot></div></div></label>`;
    }
    onChange() {
  ...
  ((e.Tab = class extends Ji(Wi(Jt)) {
    ...
    render() {
      ...
      return ft`<mdui-ripple ${Ni(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple><div part="container" class="${Gi({ container: !0, preset: !t, "variant-secondary": "secondary" === this.variant })}"><slot name="custom"><div class="icon-container">${bo(e || this.icon, i)}<slot name="icon" part="icon" class="icon">${this.icon ? ft`<mdui-icon name="${this.icon}"></mdui-icon>` : Qt}</slot></div><div class="label-container">${bo(!e, i)}<slot part="label" class="label"></slot></div></slot></div>`;
    }
  }),
    (e.Tab.styles = [ei, cr]),
  ...
  ((e.Tabs = class extends Jt {
    ...
    render() {
      return ft`<div ${Ni(this.containerRef)} part="container" class="container ${Gi({ initial: this.isInitial })}"><slot @slotchange="${this.onSlotChange}" @click="${this.onClick}"></slot><div ${Ni(this.indicatorRef)} part="indicator" class="indicator"></div></div><slot name="panel" @slotchange="${this.onSlotChange}"></slot>`;
    }
    async onSlotChange() {
  ...
  ((e.Tooltip = class extends Jt {
    ...
    render() {
      ...
      return ft`<slot></slot><div ${Ni(this.popupRef)} part="popup" class="popup" hidden>${bo(e, () => ft`<slot name="headline" part="headline" class="headline">${this.headline}</slot>`)}<slot name="content" part="content" class="content">${this.content}</slot>${bo(t, () => ft`<slot name="action" part="action" class="action"></slot>`)}</div>`;
    }
    isRich() {
  ...
  ((e.TopAppBarTitle = class extends Jt {
    ...
    render() {
      ...
      return ft`<slot part="label" class="label ${t}" ${Ni(this.defaultSlotRef)} @slotchange="${() => this.onSlotChange(e)}"></slot>${e ? ft`<slot name="label-large" part="label-large" class="label-large ${t}"></slot>` : ft`<div ${Ni(this.labelLargeRef)} part="label-large" class="label-large ${t}"></div>`}`;
    }
    onSlotChange(e) {
      e ||
